...
import { registerCoinPurseSocket } from "./integration/socket.js";
import { transferCurrencyAsGM } from "./integration/transfer-service.js";

Hooks.once("init", () => {
  console.log("Coin Purse | Module initialized");

  registerCoinPurseSocket(transferCurrencyAsGM);
